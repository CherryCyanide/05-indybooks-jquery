...
namespace IndyBooks.Controllers;
    ...
    public class AdminController : Controller
    {
        ...
        public IActionResult CreateBook()
        {
            ...
            return View(bookVM); // pass the ViewModel to populate the "AUTHOR NAME" drop down in the CreateBook View
        }
        [HttpPost]
        public IActionResult CreateBook(CreateBookVM bookVM, long id)
        {
            Writer writer;
            //Build the Writer object using the view Model info
         ...
         */
         // Write a method to take a book id, and load book and author info
